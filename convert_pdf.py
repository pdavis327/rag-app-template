...
def main():
    ...
    parser.add_argument("output_path", help="Directory to save converted Markdown files.")
    parser.add_argument(
        "--mode", 
    ...
    if not os.path.isdir(args.input_path):
        print(f"Error: Input path '{args.input_path}' is not a directory or does not exist.")
        return
